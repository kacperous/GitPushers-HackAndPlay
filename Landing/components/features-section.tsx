...
export function FeaturesSection() {
  return (
    <section id="funkcje" className="py-16 md:py-24 bg-muted/30">
        ...
        <div className="flex flex-wrap justify-center gap-6">
          {features.map((feature, index) => {
            ...
            return (
              <Card
                key={index}
                className="transition-all hover:shadow-lg hover:-translate-y-2 w-full sm:w-[calc(50%-0.75rem)] lg:w-[calc(33.333%-1rem)] max-w-sm"
              >
