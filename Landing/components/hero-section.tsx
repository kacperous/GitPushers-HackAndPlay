      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center space-y-8 animate-in fade-in slide-in-from-bottom duration-1000">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-in fade-in slide-in-from-bottom duration-1000 delay-500">
            <Button size="lg" className="gap-2 text-base transition-transform hover:scale-105 duration-200">
              Wypróbuj za darmo
              <ArrowRight className="h-4 w-4" />
            </Button>
            <Button size="lg" variant="outline" className="text-base bg-transparent transition-transform hover:scale-105 duration-200">
              Zobacz demo
            </Button>
          </div>
        </div>
